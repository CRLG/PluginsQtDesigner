...
**
** Created: Tue 30. Aug 13:53:22 2011
...
public:
    ...
    {
        propertiesDialog->setWindowTitle(QApplication::translate("propertiesDialog", "QMeter property dialog", 0));
        groupBox->setTitle(QApplication::translate("propertiesDialog", "Preview", 0));

#ifndef QT_NO_TOOLTIP
        qMeter->setToolTip(QApplication::translate("propertiesDialog", "Meter", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        qMeter->setWhatsThis(QApplication::translate("propertiesDialog", "Meter widget", 0));
#endif // QT_NO_WHATSTHIS
        qMeter->setUnits(QApplication::translate("propertiesDialog", "Km/h", 0));
        exit->setText(QApplication::translate("propertiesDialog", "Exit", 0));
        groupBox_2->setTitle(QApplication::translate("propertiesDialog", "Definition", 0));
        label_7->setText(QApplication::translate("propertiesDialog", "startAngle = The angle associated to the minimum value (double)", 0));
        label_8->setText(QApplication::translate("propertiesDialog", "endAngle = The angle associated to the maximum value (double)", 0));
        groupBox_3->setTitle(QApplication::translate("propertiesDialog", "Values", 0));
        label_9->setText(QApplication::translate("propertiesDialog", "0", 0));
        label_10->setText(QApplication::translate("propertiesDialog", "90", 0));
        label_11->setText(QApplication::translate("propertiesDialog", "180 = -180", 0));
        label_12->setText(QApplication::translate("propertiesDialog", "-90", 0));
        groupBox_4->setTitle(QApplication::translate("propertiesDialog", "Preview Example", 0));
        label_13->setText(QApplication::translate("propertiesDialog", "The preview example shows a startAngle = 210 and an EndAngle = -30", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("propertiesDialog", "Angle", 0));
        groupBox_5->setTitle(QApplication::translate("propertiesDialog", "Definition", 0));
        label_14->setText(QApplication::translate("propertiesDialog", "minValue = The minimum Value (int or double)", 0));
        label_15->setText(QApplication::translate("propertiesDialog", "maxValue= The maximum value (int or double)", 0));
        label_16->setText(QApplication::translate("propertiesDialog", "precision = Number of deciman digits (int)", 0));
        label_17->setText(QApplication::translate("propertiesDialog", "steps = Number of scale ticks (int)", 0));
        label_18->setText(QApplication::translate("propertiesDialog", "units = The measurement unit string (QString)", 0));
        label_24->setText(QApplication::translate("propertiesDialog", "threshold= The threshold value (int or double)", 0));
        label_25->setText(QApplication::translate("propertiesDialog", "value= Input Value (int or double)", 0));
        groupBox_7->setTitle(QApplication::translate("propertiesDialog", "Preview Example", 0));
        label_21->setText(QApplication::translate("propertiesDialog", "The preview example shows a minValue = 0 and a maxValue = 100", 0));
        label_22->setText(QApplication::translate("propertiesDialog", "steps = 10 and precision = 0", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("propertiesDialog", "Value", 0));
        groupBox_6->setTitle(QApplication::translate("propertiesDialog", "Definition", 0));
        label_19->setText(QApplication::translate("propertiesDialog", "foreground = Foreground Color", 0));
        label_20->setText(QApplication::translate("propertiesDialog", "background = BackGround Color", 0));
        groupBox_8->setTitle(QApplication::translate("propertiesDialog", "Preview Example", 0));
        label_23->setText(QApplication::translate("propertiesDialog", "The preview example shows a black background and a green foreground", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("propertiesDialog", "Colors", 0));
        label_26->setText(QApplication::translate("propertiesDialog", "errorSignal = This signal repots an enum value containing the error code", 0));
        label_27->setText(QApplication::translate("propertiesDialog", "thresholdAlarm = This signal reports when the input (value) exceeds the threshold", 0));
...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px"
                        "; -qt-block-indent:0; text-indent:0px; font-size:8pt;\">Note: error management is under development...</p></body></html>", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_5), QApplication::translate("propertiesDialog", "Signals", 0));
        label_28->setText(QApplication::translate("propertiesDialog", "enableThreshold = This flag enables the threshold curve and management", 0));
        label_29->setText(QApplication::translate("propertiesDialog", "enableNumericIndicator = This flag enables the numerical indicator", 0));
        checkBox->setText(QApplication::translate("propertiesDialog", "enableThreshold", 0));
        checkBox_2->setText(QApplication::translate("propertiesDialog", "enableNumericIndicator", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_6), QApplication::translate("propertiesDialog", "Flags", 0));
        label->setText(QApplication::translate("propertiesDialog", "QMeter v 0.5.2 beta", 0));
        label_2->setText(QApplication::translate("propertiesDialog", "QMeter custom widget plugin allows you to easily modify", 0));
        label_3->setText(QApplication::translate("propertiesDialog", "min and max values, start and end angle, number of steps", 0));
        label_4->setText(QApplication::translate("propertiesDialog", "background and foreground color, number of digits and units", 0));
        urlLabel->setText(QApplication::translate("propertiesDialog", "Click here to visit <a href=\"http://www.sereno-online.com/qt4lab/qmeter/\">author</a> website", 0));
        label_5->setText(QApplication::translate("propertiesDialog", "WARNING: This widget plugin is in beta version. If you find", 0));
        label_6->setText(QApplication::translate("propertiesDialog", "bugs or if you want to contribute, please contact me.", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("propertiesDialog", "About", 0));
    } // retranslateUi
